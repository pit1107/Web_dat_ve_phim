...
export const IMG_LOADING = "/img/logoLoading.png";

export const DATE_BEGIN_DANGCHIEU = "2023-01-01"; // format: yyyy-mm-dd
export const DATE_END_DANGCHIEU = "2023-02-01";

export const DATE_BEGIN_SAPCHIEU = "2023-02-02";
