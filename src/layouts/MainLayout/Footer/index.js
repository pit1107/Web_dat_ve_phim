      ...
      <div className={`${classes.footer__down} container`}>
        <div className="row">
          <div className="col-12 col-md-1 p-1 text-center">
            <img src="/img/logo-connect/PhePhimLogo.png" style={{ height: 60 }} alt="company" className={classes.logoCompany} />
          </div>
          <div className={`col-12 col-md-9 p-1 text-center text-lg-left`}>
            <span>Phê Phim - SẢN PHẨM CỦA CÔNG TY</span>
            <span>Địa chỉ: Đại học GTVT phân hiệu TPHCM, Quận Thủ Đức, Tp. Hồ Chí Minh, Việt Nam.</span>
            <span>ngày 22 tháng 01 năm 2023 Thành phố Hồ Chí Minh.</span>
            <span>Số Điện Thoại (Hotline): 0329464875</span>
            <p>Email: <span className="d-inline">support@nguyenminhphat.vn</span></p>
          </div>
